test_that("labels", {
  ...
  expect_snapshot(set_labels(datos, dict = dict, vars = c("SEXO")))
  expect_snapshot(set_labels(datos, dict = dict, vars = c("SEXO")))
  expect_snapshot(set_labels(NULL, dict = dict, vars = c("SEXO")))
  expect_snapshot(use_labels(set_labels(datos, dict = dict, ignore_case = T), dict))
